...
::: {.callout-important}
## Assignment 6 was due Sunday
[Assignment 6: Data Types & Wrangling](/assignment/06-assignment.qmd) — was due Sunday, May 17 at 11:59 PM.
:::
...
```{=html}
<a href="/slides/15-joins.html" target="_blank" class="btn btn-primary">
  <i class="fa-solid fa-arrow-up-right-from-square"></i> View slides in new tab
</a>
<a href="/slides/15-joins.pdf" class="btn btn-secondary">
...
<div class="ratio ratio-16x9">
  <iframe src="/slides/15-joins.html"></iframe>
</div>
```
