...
Submit your dataset selection, research questions, and initial plan by the end of the day.
:::
...
```{=html}
<a href="/slides/10-eda-variation.html" target="_blank" class="btn btn-primary">
  <i class="fa-solid fa-arrow-up-right-from-square"></i> View slides in new tab
</a>
<a href="/slides/10-eda-variation.pdf" class="btn btn-secondary">
...
<div class="ratio ratio-16x9">
  <iframe src="/slides/10-eda-variation.html"></iframe>
</div>
```
