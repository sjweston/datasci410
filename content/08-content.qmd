...
```{=html}
<a href="/slides/08-layers-aesthetics.html" target="_blank" class="btn btn-primary">
  <i class="fa-solid fa-arrow-up-right-from-square"></i> View slides in new tab
</a>
<a href="/slides/08-layers-aesthetics.pdf" class="btn btn-secondary">
...
<div class="ratio ratio-16x9">
  <iframe src="/slides/08-layers-aesthetics.html"></iframe>
</div>
```
