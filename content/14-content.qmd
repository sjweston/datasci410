...
```{=html}
<a href="/slides/14-joins.html" target="_blank" class="btn btn-primary">
  <i class="fa-solid fa-arrow-up-right-from-square"></i> View slides in new tab
</a>
<a href="/slides/14-joins.pdf" class="btn btn-secondary">
...
<div class="ratio ratio-16x9">
  <iframe src="/slides/14-joins.html"></iframe>
</div>
```
