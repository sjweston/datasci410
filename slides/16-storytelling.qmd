...
sprintf("%.0f", 3.14159)   # zero decimal places
sprintf("%.1f%%", 67.5)    # one decimal + a literal % sign
sprintf("%d hours", 7)     # %d for integers
...
::: {.notes}
sprintf comes from C. Format strings feel cryptic but they're a tiny language: `%` starts a slot, the next characters describe what kind of value goes there. Show students that you can mix literal text with format slots — "GPA: %.2f" produces "GPA: 3.39". Worth ~2 min.
:::
