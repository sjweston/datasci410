...
\section{Welcome to PSY 410!}\label{welcome-to-psy-410}
...
\subsection{Why data science for
psychology?}\label{why-data-science-for-psychology}
...
\textbf{Data science gives us tools to do all of this better.}
...
\tightlist
\item
  \textbf{Free and open source} --- no expensive licenses
\item
  \textbf{Designed for statistics} --- built by statisticians for data
  analysis
\item
  \textbf{Massive community} --- packages for everything
\item
  \textbf{Psychology-friendly} --- \texttt{psych}, \texttt{lavaan},
  \texttt{lme4}, \texttt{brms}\ldots{}
\item
  \textbf{Beautiful visualizations} --- ggplot2 is industry-leading
\item
  \textbf{Reproducible research} --- Quarto/RMarkdown integration
\end{itemize}
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, left=2mm, opacitybacktitle=0.6, leftrule=.75mm, colback=white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, opacityback=0, colbacktitle=quarto-callout-important-color!10!white, bottomtitle=1mm, colframe=quarto-callout-important-color-frame, rightrule=.15mm, toprule=.15mm, titlerule=0mm, toptitle=1mm, arc=.35mm, breakable, bottomrule=.15mm]
...
\subsection{More console experiments}\label{more-console-experiments}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# R can do math}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# R has built{-}in functions}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# R can store things in objects}
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, left=2mm, opacitybacktitle=0.6, leftrule=.75mm, colback=white, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, toprule=.15mm, titlerule=0mm, toptitle=1mm, arc=.35mm, breakable, bottomrule=.15mm]

\textbf{Keyboard shortcut:} Alt + - (Windows) or Option + - (Mac)

\end{tcolorbox}

\section{Projects \& workflow}\label{projects-workflow}
...
\subsection{Project folder structure}\label{project-folder-structure}
...
\item
  \textbf{RStudio makes R usable} --- learn the interface
\item
  \textbf{Projects keep you organized} --- always use them
\item
  \textbf{Scripts save your work} --- never just type in the console
\item
...
\includegraphics[width=0.3\linewidth,height=\textheight,keepaspectratio]{img/questions.png}
