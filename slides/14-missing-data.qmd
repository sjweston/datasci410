...
```{r}
#| fig-alt: "Upset plot showing which combinations of variables have missing values in the same rows, revealing whether missingness clusters across specific variable pairs."
...
4. Compute mean depression change (wave 1 to wave 3) for participants with complete data on those waves
...
# 4. Depression change for complete cases
longitudinal_study |>
...
- Draft your final project report (due next Wednesday)
...
::: {.notes}
End on this reframe. Students tend to think of NAs as a nuisance to get rid of. The takeaway is that missing data tells you something — about your study design, your participants, and potentially about your results. Remind them that Assignment 7 (Joins and Missing Data) was assigned today and is due Sun May 24, and that the final project draft is due next Wednesday (May 20). Next session covers joins, which pairs naturally with missing data — joins are a major source of NAs, and anti_join gives us another tool for finding implicit missingness.
:::
