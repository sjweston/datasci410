...
## Solution: Social media hours {background-color="#e67e22"}

```{r}
#| echo: true
#| eval: false
class_survey |>
  ggplot(aes(x = social_media_hrs)) +
  geom_histogram(
    binwidth = 2,
    fill = "navy",
    color = "white") +
...
## Solution: histogram {background-color="#e67e22"}
...
#| fig-width: 9
#| fig-height: 5
#| fig-alt: "Histogram of self-reported social media hours per day with binwidth of 2, navy fill and white borders, x-axis breaks at 0, 2, 4, 6, 8, and a minimal theme."
class_survey |>
  ggplot(aes(x = social_media_hrs)) +
  geom_histogram(
    binwidth = 2,
...
## Solution: boxplot {background-color="#e67e22"}
...
#| fig-width: 9
#| fig-height: 4
#| fig-alt: "Horizontal boxplot of self-reported social media hours per day with light grey fill and navy outline, on a black-and-white theme. Outliers appear as individual points beyond the upper whisker."
class_survey |>
  ggplot(aes(x = social_media_hrs)) +
  geom_boxplot(
    fill = "lightgrey",
