...
#| fig-width: 10
#| fig-height: 4
#| fig-alt: "Bar chart showing data split into three groups (A, B, C) with different values in each, illustrating how group_by() separates data so each group is summarized independently."
tibble(
