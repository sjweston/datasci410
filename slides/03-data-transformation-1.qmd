...
Real data rarely comes in the exact form you need:

- Filter to specific participants or conditions
- Create new variables (e.g., scale scores, dummy codes)
- Sort to find extreme values
- Select relevant columns from wide datasets

**dplyr** makes all of this straightforward.
...
# The pipe: |> {background-color="#2c3e50"}
...
We'll learn to calculate statistics by group!
