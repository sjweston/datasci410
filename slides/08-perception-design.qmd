...
You can have perfect data and a correct analysis — but if the visualization doesn't communicate, it fails.
...
## Your turn: Fix these graphs

**Placeholder for in-class activity:**

I'll show you several poorly designed graphs. With a partner, identify what's wrong and suggest specific improvements.

::: {.callout-note}
## TODO (Sara)
Add 2-3 examples of bad graphs here. Good candidates:
- Misleading y-axis (truncated or reversed)
- Poor color choices (red-green, rainbow for categories)
- Unnecessary 3D or chart junk
- Misleading pie chart or dual y-axis

For each: have students identify problems, then reveal a better version.
:::
