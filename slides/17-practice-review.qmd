...
# Today's plan {background-color="#2c3e50"}

## Where we've been

Over 17 sessions, you've learned:

✅ Data visualization with ggplot2
✅ Data transformation with dplyr
✅ Data tidying with tidyr
✅ Working with strings, factors, dates
✅ Joining datasets
...
**Today:** Put it all together with guided practice

## What we'll cover

1. **Complete workflow walkthrough** — import to final figure
2. **Common errors** — and how to fix them
3. **Debugging strategies** — when you're stuck
4. **Getting help effectively** — online and in-person
5. **Q&A for final projects**
...
**Look for red X** in RStudio margin — shows where the problem is.
...
1. ✅ Is the package loaded? (`library(tidyverse)`)
2. ✅ Did you run the code that creates the object?
3. ✅ Is your spelling/capitalization correct?
4. ✅ Are you in the right working directory?
...
- ✅ Green checkmark = accepted answer
- ✅ High upvotes = community approved
- ✅ Recent date = still relevant

. . .

**Don't just copy-paste** — understand *why* the solution works.
...
1. **Minimal data** — small sample of your data
...
- [Stack Overflow](https://stackoverflow.com) — searchable Q&A
- [Posit Community](https://community.rstudio.com) — friendly forum
- [R4DS Slack](https://r4ds.io/join) — real-time chat
- [R-Ladies](https://rladies.org) — supportive community

## How to ask a good question

1. **Search first** — your question has probably been asked

2. **Be specific** — "How do I make a bar chart?" vs "How do I make a grouped bar chart with custom colors?"

3. **Show what you tried** — demonstrates effort

4. **Provide a reprex** — make it easy for others to help you

5. **Be respectful** — people are volunteering their time
...
**"My dataset is too messy — should I find a new one?"**
...
**"I can't find a 'psychology' dataset — is that okay?"**
...
- [ ] **Method** — data source, variables, cleaning steps
- [ ] **Results** — descriptive stats + visualizations
- [ ] **Discussion** — interpretation & implications
- [ ] **Reproducible** — all code included, uses Quarto
- [ ] **Polished figures** — clear labels, good design
- [ ] **Inline code** — no hard-coded statistics
...
1. **The workflow** — import, tidy, transform, visualize, communicate
2. **Errors are normal** — read them, Google them, ask for help
3. **Debug systematically** — isolate, simplify, test
4. **Ask good questions** — include a reprex
5. **Keep practicing** — the only way to improve
6. **You can do this!** — you've already proven it

## Resources for continued learning

- **R4DS book** — comprehensive reference
- **Posit primers** — interactive tutorials
- **#TidyTuesday** — weekly data viz challenges on Twitter/Mastodon
- **R-Ladies** — supportive community, many local chapters
- **Stat 545** (UBC) — free online course materials
- **Data Science in a Box** — full course materials online

## Before next class

📖 **No new reading** — final push on projects!
