...
Psychology is facing a problem:

- Many published findings don't replicate
- Analyses are hard to reproduce
- Methods sections often lack detail
- Data and code rarely shared

. . .

**Part of the solution:** Transparent, reproducible workflows
