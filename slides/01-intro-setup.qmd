...
| Reading quizzes | 15% | 10 pre-class quizzes — graded on completion |
...
- Assigned on Wednesdays, due the following Monday
...
Before each class, you'll complete a brief Canvas quiz on the assigned reading.

. . .

Quizzes are graded on **completion, not correctness.** You get full credit for finishing — the goal is to engage with the material before we discuss it, not to memorize details.

. . .

10 quizzes total. Same late policy as assignments.
