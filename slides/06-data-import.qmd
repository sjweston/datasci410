...
I've created a messy CSV file for you. With a partner:

```{r}
# Create the messy CSV for practice
messy_survey <- tibble(
  `Participant ID` = c("P001", "P002", "P003", "P004", "P005"),
  `Age (years)` = c(22, 25, -999, 28, 31),
  `Gender` = c("Female", "Male", "Female", "N/A", "Male"),
  `Score_1` = c(4, 3, 5, 2, "N/A"),
  `Score_2` = c(3, "N/A", 4, 3, 2),
  `Notes` = c("", "transfer student", "", "", "")
)
write_csv(messy_survey, "messy_survey.csv")
```
