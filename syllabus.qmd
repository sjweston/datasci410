...
Everyone has a rough week. Each student gets **one free 48-hour extension** on any assignment — no penalty, no questions asked. To use it, email me at {{< var instructor.email >}} **within one week of the original due date** (once the next assignment is due, it's too late). One token per student for the entire term.
