...
**Assigned:** Session 6 (Wed Week 3)
**Due:** Before Session 7 (Mon Week 4)
**Topics:** pivot_longer, pivot_wider, read_csv, readxl

**Tasks:**
- [ ] Tidy a provided "wide" repeated-measures dataset
- [ ] Import a messy CSV file and clean it
...
**Assigned:** Session 10 (Wed Week 5)
...
**Assigned:** Session 12 (Wed Week 6)
**Due:** Before Session 13 (Mon Week 7)
**Topics:** logicals, numbers, strings, factors, recoding
...
Fix the messy "gender" column (has "M", "Male", "male", "MALE", etc.) and convert to a factor.

---

### Assignment 7: Joins & Missing Data
**Assigned:** Session 14 (Wed Week 7)
...
Visualize the pattern of missingness in this dataset. Which variables have the most missing data?

---

### Assignment 8: Reproducible Report
**Assigned:** Session 16 (Wed Week 9)
**Due:** Before Session 17 (Mon Week 10)
**Topics:** Quarto, literate programming, reproducibility

**Tasks:**
- [ ] Create a Quarto document that:
  - Imports and cleans a provided dataset
  - Conducts a brief EDA
  - Creates 2-3 publication-ready figures
  - Includes narrative text explaining the analysis
  - Uses inline code for statistics
- [ ] Render to both HTML and PDF
- [ ] Ensure the document renders from scratch (restart R, run all)
...
| 7 | R4DS Ch 9 | Session 7 |
| 8 | R4DS Ch 10 | Session 9 |
| 9 | R4DS Ch 12-14, 16 | Session 11 |
| 10 | R4DS Ch 18-19 | Session 13 |
