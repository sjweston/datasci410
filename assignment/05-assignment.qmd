...
### Task 2.2
Pick two Extraversion items that look interesting from your correlation matrix. Create a scatterplot of those two items with a trend line. Does the relationship match what the correlation matrix suggested?
...
| 2.1: Correlation matrix of E1–E5 | 10 |
| 2.2: Scatterplot of two Extraversion items | 10 |
