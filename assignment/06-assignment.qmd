...
### Task 1.3
Create a `scale_mean` variable that is the mean of q1, q2, q3, q4, and q5 for each participant. Make sure you use the corrected values for `q3` and  `q5`.
...
### Task 3.2
Create a bar chart of frequency of education levels. 
...
## Part 5: Text Analysis (15 points extra credit)

This part is **optional extra credit**. Completing it can add up to 15 points on top of your base score (out of 100). You can skip Part 5 entirely without penalty.
...
| Task | Points |
|------|--------|
| 1.1: Create `passed_attention` logical variable | 7 |
| 1.2: Reverse-code q3 and q5 | 8 |
| 1.3: Create `scale_mean` | 7 |
| 1.4: Create `age_group` with `case_when()` | 8 |
| 2.1: Clean `major` variable | 10 |
| 2.2: Clean `education` variable | 10 |
| 3.1: Convert education to ordered factor | 10 |
| 3.2: Bar chart of education levels (both versions) | 10 |
| 4.1: Age group factor + boxplot of scale_mean | 20 |
| QMD file knits without errors | 10 |
| **Base Total** | **100** |
| *Extra Credit* | |
| 5.1: Tokenize responses | +5 |
| 5.2: Remove stop words | +5 |
| 5.3: Word frequency bar chart | +5 |
| **Extra Credit Total** | **+15** |
