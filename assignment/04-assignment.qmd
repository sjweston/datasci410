...
**Submission:** Add `ggsave()`, the caption comment, and the justification comment to your `.R` file, clearly marked `# === GRADUATE EXTENSION ===`. Submit the saved figure file alongside your script.
