...
demographics <- tibble(
  ...
  major = c("Psych", "Bio", "Psych", "Psych", "Bio", "Bio", "Psych", "Bio"),
...
| Task | Points |
|------|--------|
| 1.1: Explore datasets and identify overlaps | 7 |
| 1.2: Use `anti_join()` to find mismatches | 8 |
| 2.1: `inner_join()` demographics + survey | 10 |
| 2.2: `left_join()` demographics + survey | 10 |
| 2.3: Summarize task data and join | 10 |
| 3.1: Missing data summary (counts + percentages) | 7 |
| 3.2: Missingness by condition | 8 |
| 3.3: Missingness visualization | 7 |
| 3.4: Complete cases vs. available data comparison | 8 |
| Part 4: Reflection (3 questions) | 15 |
