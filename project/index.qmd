...
- A **5-minute presentation** sharing your key findings with the class
...
| [Presentation](04-presentation.qmd) | Finals Week | 5-minute share-out |
...
The final project follows the same AI policy as weekly assignments: **AI-permitted with documentation.** You must include a process documentation section in your final report describing how you used AI tools (if at all) and what you learned from the process. See the [syllabus](/syllabus.qmd#ai-tools-policy) for the full policy.
